...
const houghOptions = [
  ...
  { label: 'Ellipses Detection', value: 'ellipses' }
];
...
const inputs = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { label: 'Min Radius', name: 'minRadius', min: 0, max: 5000, step: 1 },
      { label: 'Max Radius', name: 'maxRadius', min: 0, max: 5000, step: 1 }
    ]
  },
  {
    value: 'ellipses',
...
function Hough() {
  ...
  const { data } = useHandleProcessing({
    ...
    errorMessage: "Hough transform couldn't be applied to your image. Please try again."
  });
