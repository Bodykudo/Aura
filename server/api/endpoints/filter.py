...
async def applyFilter(image_id: str, filter: FilterModel):
    ...
    if filter.type == "average":
        ...
        filtered_image = Filter.apply_gaussian_filter(image_path, filter.kernelSize, filter.sigma)
    ...
    return {"success": True, "message": "Filter applied successfully.", "image": filtered_image}