...
class SiftMatching:
    ...
    def get_matching(
        ...
        if method == "ncc":
            matches_ncc = SiftMatching.matching(
                descriptors_1, descriptors_2, SiftMatching.calculate_ncc
            )
            ...
            matches_ssd = SiftMatching.matching(
                descriptors_1, descriptors_2, SiftMatching.calculate_ssd
            )
            matched_image = cv2.drawMatches(
                image_1,
                keypoints_1,
...
sift_1 = SIFT("box.png")
sift_1.apply()
keypoints_1 = sift_1.get_keypoints()
descriptors_1 = sift_1.get_descriptors()
image_1_with_keypoints = sift_1.draw_keypoints()
cv2.imshow("Image with keypoints", image_1_with_keypoints)
cv2.waitKey(0)
cv2.destroyAllWindows()

print("Getting second image")
sift_2 = SIFT("box_in_scene.png")
sift_2.apply()
keypoints_2 = sift_2.get_keypoints()
descriptors_2 = sift_2.get_descriptors()
image_2_with_keypoints = sift_2.draw_keypoints()
cv2.imshow("Image with keypoints", image_2_with_keypoints)
cv2.waitKey(0)
cv2.destroyAllWindows()

print("Getting matching")
matched_image = SiftMatching.get_matching(
    "box.png",
    keypoints_1,
    descriptors_1,
    "box_in_scene.png",
